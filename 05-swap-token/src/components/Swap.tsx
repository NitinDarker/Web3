    ...
    <div className='flex flex-col justify-center items-center mt-10'>
      <div className='flex flex-col gap-5'>
        ...
        <div className='flex flex-col bg-neutral-800 gap-5 p-5 rounded-2xl border border-neutral-600'>
          <Input placeholder='0' ref={fromRef} className='h-15 text-xl rounded-2xl' label='Sell'/>
          <Input placeholder='0' ref={toRef} className='h-15 text-xl rounded-2xl' label='Buy'/>
          <Button onClick={swapHandler} className='h-10 rounded-2xl'>Swap</Button>
        </div>
      </div>
    </div>
  )
